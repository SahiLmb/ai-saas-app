  ...
  return (
    <div>
      <div>
        ...
        px-12 py-3 text-center text-sm font-normal bg-primary text-white
          hover:ring-1 hover:ring-yellow-400 focus:outline-none focus:ring active:text-green-500"
      >
        Currently Active Plan
            ...
            <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
              ...
              <Button
                ...
                className="w-full rounded-full mt-5 p-6 bg-primary text-white"
                variant="outline"
              >
                {/* Get Started */}
