...
export default[
    {
        name:'Blog Title',
        desc:'An AI tool that generates blog title depending on the prompt provided by user',
        category:'Blog',
        icon:'https://cdn-icons-png.flaticon.com/128/2800/2800039.png',
        slug:'generate-blog-title',
        aiPrompt:'Give me 5 to 10 blog topic idea in bullet points based on only given niche and outline topic and give me result in text editor file',
        form:[
            {
    ...
    },
    {
        ...
        aiPrompt: 'Depends on user productName and description generate small description for product for e-commerce business and give output in rich text editor format  ',
        form: [
            {
                label: 'Product Name',
                field: 'input',
